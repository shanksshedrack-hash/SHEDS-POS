...
var POS = (function() {
    ...
    function renderSidebar() {
        ...
        var groups = [
            ...
            {title:'Reports',items:[['reports.html','Reports','fa-chart-bar'],['audit-log.html','Audit Log','fa-clipboard-list'],['backups.html','System Backups','fa-download'],['config.html','Store Config','fa-cog'],['customer-history.html','Customer History','fa-user-clock'],['login.html','Logout','fa-sign-out-alt']]}
        ];
